...
# הרחב מטריצה לקבלת מטריצה של נתונים של 48 סיביות ליישום ה- xor עם Ki
E = [32, 1, 2, 3, 4, 5,
     4, 5, 6, 7, 8, 9,
     8, 9, 10, 11, 12, 13,
     12, 13, 14, 15, 16, 17,
...
# מטריצה שקובעים את המשמרת עבור כל סיבוב מפתחות
...
class des():
    ...
    def run(self, key, text, action=ENCRYPT, padding=False):
        ...
        #בשלב זה הקוד עושה את כל התהליך עם פעולות XOR  עם החלפת מיקומים וביטים
        self.generatekeys() 
